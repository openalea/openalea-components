...
from openalea.core import IFunction
...
_77042384 = CNF(uid="d7abaec84e7911e6bff6d4bed973e64a",
                name='tutorial parallel_map',
                description='',
                ...
                elt_data={2: {'block': False,
                          ...
                          9: {'block': False,
                              ...
                              'user_color': None},
                          10: {
                              'factory': '<openalea.core.node.NodeFactory object at 0x8c713d0> : "annotation"',
                              'id': 10,
                ...
                elt_value={2: [],
                           ...
                           '__in__': [],
                           '__out__': []},
                elt_ad_hoc={2: {'position': [-195.0, 65.0], 'userColor': None,
                                'useUserColor': False},
                            3: {'position': [-237.95866700480522,
                                             -52.79412636388825],
                                'userColor': None, 'useUserColor': False},
                            4: {'position': [-79.0, -54.0], 'userColor': None,
                                'useUserColor': False},
                            5: {'position': [108.42564121115043,
                                             75.9446333678437],
                                'userColor': None, 'useUserColor': False},
                            6: {'position': [65.91727369449718,
                                             -51.447628249363646],
                                'userColor': None, 'useUserColor': False},
                            7: {'position': [221.2101644455652,
                                             -43.859235823552595],
                                'userColor': None, 'useUserColor': False},
                            8: {'position': [84.40626509661223,
                                             8.038691913963063],
                                'userColor': None, 'useUserColor': False},
                            9: {'position': [124.59972466642756,
                                             -49.839889866571035],
                                'userColor': None, 'useUserColor': False},
                            10: {'visualStyle': 0,
                                 'position': [-212.26618858133065,
                                              133.05465967171213],
                                 'color': None,
                                 'text': 'launch  in a shell:\nipcluster start --n=2 ',
                                 'textColor': None, 'rectP2': (-1, -1)},
                            11: {'visualStyle': 0,
                                 'position': [100.95587017892555,
                                              143.40910789519168],
                                 'color': None,
                                 'text': 'Error raised:\nFunctionType',
                                 'textColor': None, 'rectP2': (-1, -1)},
...
_77042512 = CNF(uid="d7abaec94e7911e6bff6d4bed973e64a",
                name='tutorial pmap',
                description='',
                category='Unclassified',
                doc='',
                ...
                elt_data={2: {'block': False,
                          ...
                          16: {'block': False,
                               ...
                               'user_color': None},
                          17: {
                              'factory': '<openalea.core.node.NodeFactory object at 0xabd9a4c> : "annotation"',
                              'id': 17,
                              'posx': 29.678848943867948,
                              'posy': -93.74747523539251,
                              'txt': 'Parallel Map on 4 processors'},
                          18: {
                              'factory': '<openalea.core.node.NodeFactory object at 0xac6728c> : "annotation"',
                              'id': 18,
                              'posx': -220.364398945261,
                              'posy': -93.6404248833485,
                              'txt': 'Map on a single processor'},
                          '__in__': {'block': False,
                                     'caption': 'In',
                                     'delay': 0,
                                     'hide': True,
                ...
                elt_value={2: [(0, '100')],
                           ...
                           '__out__': []},
                elt_ad_hoc={
                    2: {'position': [172.9981227710845, -48.88660504735711],
                        'useUserColor': False,
                        'userColor': None},
...
_77042448 = CNF(uid="d7abaeca4e7911e6bff6d4bed973e64a",
                name='x+1',
                description='',
                category='Unclassified',
                doc='',
                ...
                elt_data={2: {'block': False,
                          ...
                          '__out__': {'block': False,
                                      ...
                                      'user_application': None,
                                      'user_color': None}},
                elt_value={2: [(0, "'x'")], 3: [], 4: [(0, '1')], '__in__': [],
                           '__out__': []},
                elt_ad_hoc={
                    2: {'position': [-749.0, -508.0], 'useUserColor': False,
                        'userColor': None},
                    3: {'position': [-700.0, -430.0], 'useUserColor': False,
                        'userColor': None},
                    4: {'position': [-642.0, -506.0], 'useUserColor': False,
                        'userColor': None},
                    '__in__': {'position': [0, 0], 'useUserColor': True,
                               'userColor': None},
