...
# Meta information
long_description= '''
svgdraw package aims at manipulating
vectorial graphics keeping close to SVG
standar. It provide objects and functions
 - to read write an svg file
 - to create SVG scene and fill it
 - to retrieve the geometry of complex
   geometrical objects like path
'''
