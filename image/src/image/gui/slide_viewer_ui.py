...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_close.setText(QtWidgets.QApplication.translate("MainWindow", "close", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_close.setToolTip(QtWidgets.QApplication.translate("MainWindow", "close window", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_close.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Esc", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_snapshot.setText(QtWidgets.QApplication.translate("MainWindow", "snapshot", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_snapshot.setToolTip(QtWidgets.QApplication.translate("MainWindow", "take snapshot", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_rotate_left.setText(QtWidgets.QApplication.translate("MainWindow", "rotate left", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_rotate_left.setToolTip(QtWidgets.QApplication.translate("MainWindow", "rotate left", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_rotate_right.setText(QtWidgets.QApplication.translate("MainWindow", "rotate right", None, QtWidgets.QApplication.UnicodeUTF8))
        self.action_rotate_right.setToolTip(QtWidgets.QApplication.translate("MainWindow", "rotate right", None, QtWidgets.QApplication.UnicodeUTF8))
