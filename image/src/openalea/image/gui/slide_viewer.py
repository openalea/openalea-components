...
class SlideViewer (QtWidgets.QMainWindow) :
    ...
    def __init__ (self, parent=None) :
        ...
        self.ui.action_snapshot.triggered.connect(self.snapshot)

        self.ui.action_rotate_left.triggered.connect(self.rotate_left)

        self.ui.action_rotate_right.triggered.connect(self.rotate_right)
        ...
        self._palette_select.currentIndexChanged.connect(self.palette_name_changed)
        #axis
        ...
        self._axis.currentIndexChanged.connect(self.change_axis)
